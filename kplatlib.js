...
function loadLoginTable(callback) {
        ...
        var cgicmd = "https://kplat.cu.ma/cgi-bin/kplat_php.php?phpfun=readlogin";
...
function updateLoginTable(person,field,value,callback) {
	var xhttp = new XMLHttpRequest();
        var cgicmd = "https://kplat.cu.ma/cgi-bin/kplat_php.php?phpfun=updatelogin&person=" + person + "&field=" + field + "&value=" + value;
        xhttp.open("GET", cgicmd, true);
        xhttp.send();
        callback();
}
