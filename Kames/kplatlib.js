...
function creditPoints(amount) {
  ...
  function creditKamesPoints(amount) {
    loadLoginTable(function() {
    var username = loadCurrentUser();
    var user_data = findUser(username);	
    user_data.Kames_points = Number(user_data.Kames_points)+ amount;
    var points = user_data.Kames_points;
    updateLoginTable(username, 'Kames_points', points,function() {
    saveLoginTable();
    if(loadCurrentApp() == "ATM") {
    document.getElementById("kapoints").innerHTML = "You have " + points + " Kames points.";
    }
    })
    })
  }
  ...
  function debitKamesPoints(amount) {
    loadLoginTable(function() {
    var username = loadCurrentUser();
    var user_data = findUser(username);	
    user_data.Kames_points = Number(user_data.Kames_points)- amount;
